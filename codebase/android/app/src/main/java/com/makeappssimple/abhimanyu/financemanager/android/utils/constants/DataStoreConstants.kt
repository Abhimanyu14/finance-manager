...
val DEFAULT_INCOME_CATEGORY_ID: Preferences.Key<Int> = intPreferencesKey("default_income_category_id")
val DEFAULT_EXPENSE_CATEGORY_ID: Preferences.Key<Int> = intPreferencesKey("default_expense_category_id")
