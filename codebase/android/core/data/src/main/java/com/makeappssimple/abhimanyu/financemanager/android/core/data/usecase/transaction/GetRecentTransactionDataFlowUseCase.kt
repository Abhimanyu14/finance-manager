...
private object GetRecentTransactionDataFlowUseCaseConstant {
...
public class GetRecentTransactionDataFlowUseCase @Inject constructor(
    ...
    public operator fun invoke(
        numberOfTransactions: Int = GetRecentTransactionDataFlowUseCaseConstant.DEFAULT_NUMBER_OF_RECENT_TRANSACTIONS,
