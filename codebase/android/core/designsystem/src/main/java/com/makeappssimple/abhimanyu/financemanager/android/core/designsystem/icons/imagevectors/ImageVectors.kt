...
public val Icons.Rounded.AccountBalanceWallet: ImageVector
    get() {
        ...
        _accountBalanceWallet = materialIcon(name = "Rounded.AccountBalanceWallet") {
            materialPath {
                moveTo(10.0f, 16.0f)
                lineTo(10.0f, 8.0f)
...
public val Icons.Rounded.RadioButtonUnchecked: ImageVector
    get() {
        ...
        _radioButtonUnchecked = materialIcon(name = "Rounded.RadioButtonUnchecked") {
            materialPath {
                moveTo(12.0f, 2.0f)
...
public val Icons.Rounded.SwapVert: ImageVector
    get() {
        ...
        _swapVert = materialIcon(name = "Rounded.SwapVert") {
            materialPath {
                moveTo(16.0f, 17.01f)
...
public val Icons.AutoMirrored.Rounded.TextSnippet: ImageVector
    get() {
        ...
        _textSnippet = materialIcon(name = "AutoMirrored.Rounded.TextSnippet", autoMirror = true) {
            materialPath {
                moveTo(14.17f, 3.0f)
                horizontalLineTo(5.0f)
                curveTo(3.9f, 3.0f, 3.0f, 3.9f, 3.0f, 5.0f)
