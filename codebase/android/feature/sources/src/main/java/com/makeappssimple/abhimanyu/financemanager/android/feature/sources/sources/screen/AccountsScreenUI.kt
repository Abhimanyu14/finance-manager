            ...
            when (uiState.accountsBottomSheetType) {
                AccountsBottomSheetType.DELETE_CONFIRMATION -> {
                    AccountsDeleteConfirmationBottomSheet(
                        ...
                        uiState.accountIdToDelete?.let { sourceId ->
                            events.deleteAccount(sourceId)
                        }
                    }
                }
                    ...
                    events = AccountsListItemEvents(
                        ...
                        onEditClick = {
                            listItem.sourceId?.let {
                                events.navigateToEditAccountScreen(listItem.sourceId)
                            }
                            uiState.setExpandedItemIndex(null)
                        },
                        onDeleteClick = {
                            uiState.setAccountIdToDelete(listItem.sourceId)
